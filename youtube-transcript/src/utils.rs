...
pub(crate) fn to_human_readable(duration: &Duration) -> String {
    ...
    match dur {
        ...
        1_000_000u128..=999_999_999 => format!("{}ms", dur / 1_000_000),
        1_000_000_000u128..=59_999_999_999 => format!("{}s", dur / 1_000_000_000),
        60_000_000_000u128..=3_599_999_999_999 => {
            format!(
                "{}m {}s",
        ...
        _ => format!(
            ...
            (dur % 3_600_000_000_000) / 60_000_000_000,
        ),
    }
}
